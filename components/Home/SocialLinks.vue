<template>
  <div>
    <h2 class="uppercase text-xs font-semibold text-gray-400 mb-4">RETROUVER MOI SUR</h2>
    <div class="space-y-5">
      <NuxtLink
        v-for="link in links"
        :key="link.icon"
...
const links = [
  {
    name: "GitHub",
    url: "https://github.com/ludonvl",
    icon: "mdi:github",
  },
  {
    name: "Linkedin",
    url: "https://www.linkedin.com/in/ludovicnouvel/",
    icon: "mdi:linkedin",
  },
];
</script>
